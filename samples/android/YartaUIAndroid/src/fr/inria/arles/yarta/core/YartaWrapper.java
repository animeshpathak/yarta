...
import fr.inria.arles.yarta.AsyncRunner;
import fr.inria.arles.yarta.ResourceActivity;
...
public class YartaWrapper {
	...
	public boolean init(String userId, Object object, MSEApplication application) {
		...
		this.userId = userId;
		this.kbUserId = "Person_" + userId;
		try {
			mseManager.initialize(dataPath + "/" + baseOntologyFilePath,
		...
		this.kbUserId = "http://yarta.gforge.inria.fr/ontologies/mse.rdf#"
				+ this.kbUserId;
		initialized = true;
		return true;
	}
	...
	private void ensureBaseFiles(Context context) {
		...
		File rdfFile = context.getFileStreamPath(baseOntologyFilePath);
	...
	public Set<Person> getAllPersons() {
		return accessManager.getAllPersons();
	}
	...
	public StorageAccessManager getAccessManager() {

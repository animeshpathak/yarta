...
public class EventImpl extends YartaResource implements Event {
	...
	/**
	 * Creates a "istagged" edge between this event and topic
	 * 
	 * @param	topic
	 *			the Topic
	 *
	...
	/**
	 * deletes the "istagged" link between this event and topic
	 * 
	 * @param	topic
	 * 			the Topic
	...
	/**
	 * Creates a "islocated" edge between this event and place
	 * 
	 * @param	place
	 *			the Place
	 *
	...
	/**
	 * deletes the "islocated" link between this event and place
	 * 
	 * @param	place
	 * 			the Place
	 * @return true if success. false is something went wrong

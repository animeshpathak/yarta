...
public class PictureImpl extends YartaResource implements Picture {
	 ...
	 */
	@Override
	public Set<fr.inria.arles.yarta.resources.Group> getHasContent_inverse() {
		return sam.getObjectProperty_inverse(kbNode, fr.inria.arles.yarta.resources.Group.PROPERTY_HASCONTENT_URI);
	}

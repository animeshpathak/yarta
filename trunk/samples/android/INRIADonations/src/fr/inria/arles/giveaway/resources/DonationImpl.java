...
/**
 * 
 * Donation class implementation.
 *
 */
public class DonationImpl extends YartaResource implements Donation {

	/**
	 * Wraps a given node into a DonationImpl object
	 * 
	 * @param	sam
	 ...
	 * 			The node to wrap
	 */
	public DonationImpl(ThinStorageAccessManager sam, Node n) {
		super(sam, n);
	}
	...
	/**
	 * Creates a "istagged" edge between this donation and topic
	 * 
	 * @param	topic
	 *			the Topic
	 *
	...
	/**
	 * deletes the "istagged" link between this donation and topic
	 * 
	 * @param	topic
	 * 			the Topic
	...
	/**
	 * Creates a "picture" edge between this donation and picture
	 * 
	 * @param	picture
	 *			the Picture
	 *
	...
	/**
	 * deletes the "picture" link between this donation and picture
	 * 
	 * @param	picture
	 * 			the Picture
	 * @return true if success. false is something went wrong
	...
	/**
	 * Creates a "category" edge between this donation and category
	 * 
	 * @param	category
	 *			the Category
	 *
	...
	/**
	 * deletes the "category" link between this donation and category
	 * 
	 * @param	category
	 * 			the Category
	 * @return true if success. false is something went wrong
	...
	/**
	 * Creates a "hasreply" edge between this donation and content
	 * 
	 * @param	content
	 *			the Content
	 *
	...
	/**
	 * deletes the "hasreply" link between this donation and content
	 * 
	 * @param	content
	 * 			the Content
	 * @return true if success. false is something went wrong
	...
	/**
	 * Creates a "hiddenby" edge between this donation and person
	 * 
	 * @param	person
	 *			the Person
	 *
	...
	/**
	 * deletes the "hiddenby" link between this donation and person
	 * 
	 * @param	person
	 * 			the Person
	 * @return true if success. false is something went wrong

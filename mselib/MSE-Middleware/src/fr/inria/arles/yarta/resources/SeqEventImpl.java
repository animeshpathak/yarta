...
/**
 * A set of sequential events.
 */
public class SeqEventImpl extends YartaResource implements SeqEvent {

	/**
	 * Wraps a given node into a SeqEventImpl object
	 * 
	 * @param sam
	 ...
	 *            The node to wrap
	 */
	public SeqEventImpl(ThinStorageAccessManager sam, Node n) {
		super(sam, n);
	}

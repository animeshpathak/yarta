...
/**
 * Interface for loggers used in the Yarta middleware. The loglevels are
 * debug, info, warn, and error. Modeled after the Android Log class, 
 * but valid in other contexts too.
 * @author pathak
 *
 */

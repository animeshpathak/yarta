 ...
 *
 */
public class RequestImpl extends YartaResource implements Request {

	/**
	 * Wraps a given node into a RequestImpl object
	 * 
	 * @param	sam
	 ...
	 * 			The node to wrap
	 */
	public RequestImpl(ThinStorageAccessManager sam, Node n) {
		super(sam, n);
	}
	...
	/**
	 * Creates a "istagged" edge between this request and topic
	 * 
	 * @param	topic
	 *			the Topic
	 *
	...
	/**
	 * deletes the "istagged" link between this request and topic
	 * 
	 * @param	topic
	 * 			the Topic
	...
	/**
	 * Creates a "picture" edge between this request and picture
	 * 
	 * @param	picture
	 *			the Picture
	 *
	...
	/**
	 * deletes the "picture" link between this request and picture
	 * 
	 * @param	picture
	 * 			the Picture
	 * @return true if success. false is something went wrong
	...
	/**
	 * Creates a "category" edge between this request and category
	 * 
	 * @param	category
	 *			the Category
	 *
	...
	/**
	 * deletes the "category" link between this request and category
	 * 
	 * @param	category
	 * 			the Category
	 * @return true if success. false is something went wrong
	...
	/**
	 * Creates a "hasreply" edge between this request and content
	 * 
	 * @param	content
	 *			the Content
	 *
	...
	/**
	 * deletes the "hasreply" link between this request and content
	 * 
	 * @param	content
	 * 			the Content
	 * @return true if success. false is something went wrong
	...
	/**
	 * Creates a "hiddenby" edge between this request and person
	 * 
	 * @param	person
	 *			the Person
	 *
	...
	/**
	 * deletes the "hiddenby" link between this request and person
	 * 
	 * @param	person
	 * 			the Person
	 * @return true if success. false is something went wrong

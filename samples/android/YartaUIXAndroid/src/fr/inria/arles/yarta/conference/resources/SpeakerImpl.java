 ...
 *
 */
public class SpeakerImpl extends YartaResource implements Speaker {

	/**
	 * Wraps a given node into a SpeakerImpl object
	 * 
	 * @param	sam
	 ...
	 * 			The node to wrap
	 */
	public SpeakerImpl(ThinStorageAccessManager sam, Node n) {
		super(sam, n);
	}
	 ...
	 * @throws	KBException
	 */
	public SpeakerImpl(ThinStorageAccessManager sam, String uniqueRequestorId) {
		super(sam, sam.createNewNode(Speaker.typeURI));
	...
	/**
	 * Creates a "knows" edge between this speaker and agent
	 * 
	 * @param	agent
	 *			the Agent
	 *
	...
	/**
	 * deletes the "knows" link between this speaker and agent
	 * 
	 * @param	agent
	 * 			the Agent
	...
	/**
	 * Creates a "istagged" edge between this speaker and topic
	 * 
	 * @param	topic
	 *			the Topic
	 *
	...
	/**
	 * deletes the "istagged" link between this speaker and topic
	 * 
	 * @param	topic
	 * 			the Topic
	 * @return true if success. false is something went wrong
	...
	/**
	 * Creates a "isattending" edge between this speaker and event
	 * 
	 * @param	event
	...
	/**
	 * deletes the "isattending" link between this speaker and event
	 * 
	 * @param	event
	 * 			the fr.inria.arles.yarta.resources.Event
	 * @return true if success. false is something went wrong
	...
	/**
	 * Creates a "hasinterest" edge between this speaker and resource
	 * 
	 * @param	resource
	 *			the Resource
	 *
	...
	/**
	 * deletes the "hasinterest" link between this speaker and resource
	 * 
	 * @param	resource
	 * 			the Resource
	 * @return true if success. false is something went wrong
	...
	/**
	 * Creates a "ismemberof" edge between this speaker and group
	 * 
	 * @param	group
	 *			the Group
	 *
	...
	/**
	 * deletes the "ismemberof" link between this speaker and group
	 * 
	 * @param	group
	 * 			the Group
	 * @return true if success. false is something went wrong
	...
	/**
	 * Creates a "participatesto" edge between this speaker and conversation
	 * 
	 * @param	conversation
	 *			the Conversation
	 *
	...
	/**
	 * deletes the "participatesto" link between this speaker and conversation
	 * 
	 * @param	conversation
	 * 			the Conversation
	 * @return true if success. false is something went wrong
	...
	/**
	 * Creates a "islocated" edge between this speaker and place
	 * 
	 * @param	place
	 *			the Place
	 *
	...
	/**
	 * deletes the "islocated" link between this speaker and place
	 * 
	 * @param	place
	 * 			the Place
	 * @return true if success. false is something went wrong
	...
	/**
	 * Creates a "creator" edge between this speaker and content
	 * 
	 * @param	content
	 *			the Content
	 *
	...
	/**
	 * deletes the "creator" link between this speaker and content
	 * 
	 * @param	content
	 * 			the Content
	 * @return true if success. false is something went wrong

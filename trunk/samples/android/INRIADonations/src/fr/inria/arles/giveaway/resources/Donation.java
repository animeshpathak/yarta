...
/**
 * 
 * Donation interface definition.
 *
 */
public interface Donation extends Resource, Content, Announcement {
	public static final String typeURI = MSEManagerEx.baseMSEURI + "#Donation";

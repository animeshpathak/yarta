 ...
 * Single Event
 */
public class SingleEventImpl extends YartaResource implements SingleEvent {

	/**
	 * Wraps a given node into a SingleEventImpl object
	 * 
	 * @param sam
	 ...
	 *            The node to wrap
	 */
	public SingleEventImpl(ThinStorageAccessManager sam, Node n) {
		super(sam, n);
	}

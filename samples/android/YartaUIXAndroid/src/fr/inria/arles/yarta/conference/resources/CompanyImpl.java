 ...
 *
 */
public class CompanyImpl extends YartaResource implements Company {

	/**
	 * Wraps a given node into a CompanyImpl object
	 * 
	 * @param	sam
	 ...
	 * 			The node to wrap
	 */
	public CompanyImpl(ThinStorageAccessManager sam, Node n) {
		super(sam, n);
	}
	...
	/**
	 * Creates a "knows" edge between this company and agent
	 * 
	 * @param	agent
	 *			the Agent
	 *
	...
	/**
	 * deletes the "knows" link between this company and agent
	 * 
	 * @param	agent
	 * 			the Agent
	...
	/**
	 * Creates a "istagged" edge between this company and topic
	 * 
	 * @param	topic
	 *			the Topic
	 *
	...
	/**
	 * deletes the "istagged" link between this company and topic
	 * 
	 * @param	topic
	 * 			the Topic
	 * @return true if success. false is something went wrong
	...
	/**
	 * Creates a "isattending" edge between this company and event
	 * 
	 * @param	event
	...
	/**
	 * deletes the "isattending" link between this company and event
	 * 
	 * @param	event
	 * 			the fr.inria.arles.yarta.resources.Event
	 * @return true if success. false is something went wrong
	...
	/**
	 * Creates a "hasinterest" edge between this company and resource
	 * 
	 * @param	resource
	 *			the Resource
	 *
	...
	/**
	 * deletes the "hasinterest" link between this company and resource
	 * 
	 * @param	resource
	 * 			the Resource
	 * @return true if success. false is something went wrong
	...
	/**
	 * Creates a "ismemberof" edge between this company and group
	 * 
	 * @param	group
	 *			the Group
	 *
	...
	/**
	 * deletes the "ismemberof" link between this company and group
	 * 
	 * @param	group
	 * 			the Group
	 * @return true if success. false is something went wrong
	...
	/**
	 * Creates a "participatesto" edge between this company and conversation
	 * 
	 * @param	conversation
	 *			the Conversation
	 *
	...
	/**
	 * deletes the "participatesto" link between this company and conversation
	 * 
	 * @param	conversation
	 * 			the Conversation
	 * @return true if success. false is something went wrong
	...
	/**
	 * Creates a "islocated" edge between this company and place
	 * 
	 * @param	place
	 *			the Place
	 *
	...
	/**
	 * deletes the "islocated" link between this company and place
	 * 
	 * @param	place
	 * 			the Place
	 * @return true if success. false is something went wrong
	...
	/**
	 * Creates a "creator" edge between this company and content
	 * 
	 * @param	content
	 *			the Content
	 *
	...
	/**
	 * deletes the "creator" link between this company and content
	 * 
	 * @param	content
	 * 			the Content
	 * @return true if success. false is something went wrong

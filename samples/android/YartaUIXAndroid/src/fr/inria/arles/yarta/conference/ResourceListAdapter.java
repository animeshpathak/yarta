...
public class ResourceListAdapter extends BaseAdapter implements
	...
	public void setEditable(boolean editable, ItemCheck checkHandler) {
			...
			holder.updateButton.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					wrapper.runner.run(new AsyncRunner.Job() {
						...
						public void doWork() {
							Person person = (Person) lstResources.get(position);
							success = wrapper.sendUpdate(person.getUserId());
						}
						...
						public void onCheckedChanged(CompoundButton buttonView,
							...
							if (checkHandler != null) {
								checkHandler.onItemCheck(
										(Resource) lstResources.get(position),
										isChecked);
							}
						}
					});
	...
	private ItemCheck checkHandler;
